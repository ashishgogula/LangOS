export default function BillingPage() {
  return (
    <div className="section-stack mx-auto max-w-4xl">
      ...
      <section className="surface-card p-6 sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-dotted border-zinc-200 pb-4">
          <div>
        ...
        <dl className="dotted-grid-2 mt-4 text-sm text-zinc-700">
          <div className="p-4">
